...
class ImageNotExistInManagerException extends GalleryException {
  constructor(image, fileName, lineNumber) {
    super(
    ...
    this.image = image;
    this.name = "ImageNotExistInManagerException";
  }
}
class Category {
  #title;
  ...
  function init() {
    ...
    class Gallery {
      ...
      removeImage() {
        for (let image of arguments) {
          ...
          if (position !== -1) {
            ...
            throw new ImageNotExistInManagerException(image);
          }
        }
        return this;
      }
      removeAuthor() {
        for (let author of arguments) {
          ...
          if (position !== -1) {
            ...
            throw new ImageNotExistInManagerException(author);
          }
        }
        return this;
      }
      ...
      getImage(title) {
        ...
        if (position === -1)
          throw new ImageNotExistInManagerException(
