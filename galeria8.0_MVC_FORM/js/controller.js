...
class GalleryController {
    ...
    try {
      ...
      categories.forEach((title2) => {
        authors.forEach((nickname) => {
          ...
          this.#modelGallery.addImageInCategoryWithAuthor(category, author, image);
        });
  ...
  handleRemoveImageForm = () => {
		this.#viewGallery.showRemoveImageForm(this.#modelGallery.categories, this.#modelGallery.authors);
		this.#viewGallery.bindRemoveImageSelects(this.handleRemoveImageListByType, this.handleRemoveImageListByCategory,this.handleRemoveImageListByAuthor);
	}
  handleRemoveImageListByType = (type) => {
    ...
    this.#viewGallery.showRemoveImageList (this.#modelGallery.getTypeImages(instance[type]));
  ...
  handleRemoveImageListByCategory = (category) => {
    ...
    this.#viewGallery.showRemoveImageList(this.#modelGallery.getCategoryImage(cat));
    this.#viewGallery.bindRemoveImage(this.handleRemoveImage);
    this.#viewGallery.bindShowImage(this.handleShowImage);
  }
  handleRemoveImageListByAuthor = (author) => {
    let aut = this.#modelGallery.getAuthor(author);
    this.#viewGallery.showRemoveImageList(this.#modelGallery.getAuthorImage(aut));
    this.#viewGallery.bindRemoveImage(this.handleRemoveImage);
    this.#viewGallery.bindShowImage(this.handleShowImage);
  }
